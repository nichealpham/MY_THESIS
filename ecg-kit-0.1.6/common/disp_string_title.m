...
%     present a message string2display entitled with '-' characters below.
% 
%   str_out = disp_string_title(style, string2display )
% 
% Arguments:
% 
...
% 
% 
% See also disp_string_framed, disp_option_enumeration
% 
...
% Copyright 2008-2015
% 
function str_out = disp_string_title(style, string2display )
