function varargout = guimea1mea2plot(varargin)
%========================================================================
%     <guimea1mea2plot.m>, v 1.0 2010/02/11 22:09:14  Kugiumtzis & Tsimpiris
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @guimea1mea2plot_OpeningFcn, ...
                   'gui_OutputFcn',  @guimea1mea2plot_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before guimea1mea2plot is made visible.
function guimea1mea2plot_OpeningFcn(hObject, eventdata, handles, varargin)
...
messageS = sprintf('Graph measure1 vs measure2: \n Exactly two mesures should be selected. The measure value pair is drawn as a point for each time series.');
set(handles.edit1,'String',messageS);

% Choose default command line output for guimea1mea2plot
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);

% --- Outputs from this function are returned to the command line.
function varargout = guimea1mea2plot_OutputFcn(hObject, eventdata, handles) 
...
if cols ~= 2
    messageS = sprintf('Exactly two measures should be selected for displaying the graph measure1 vs measure2.');
    set(handles.edit1,'String',messageS);
else
    ...
    handles.PlotFigure = figure('NumberTitle','Off','Name','Measure1 vs Measure2',...
        'PaperOrientation','Landscape');
    plot(plottableM(:,1),plottableM(:,2),'.','Markersize',10)
    hold on
