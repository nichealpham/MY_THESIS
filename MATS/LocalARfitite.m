...
% local model that are allowed to vary (components of the input vectors). 
...
%========================================================================
%     <LocalARfitite.m>, v 1.0 2010/02/11 22:09:14  Kugiumtzis & Tsimpiris
    ...
    for im=1:nm
        ...
        for innei=1:nnnei
            ...
            for i=1:nvec
                ...
                preM(i,1) = lppreone(xV,TreeRoot,winnowV,m,tau,nnei,qnow,mindist,1);
                winnowV = [winnowV(2:end);preM(i,1)];
                for T = 2:Tmax
                    % Calls the function that makes one step prediction
                    preM(i,T) = lppreone(xV,TreeRoot,winnowV,m,tau,nnei,qnow,mindist,0);
