%========================================================================
%     <imgsegmentplotbutton.m>, v 1.0 2010/02/11 22:09:14  Kugiumtzis & Tsimpiris
...
set(leg,'FontSize',24)
ax = axis;
xlabel('segment index','fontsize',50)
ylabel('measure','fontsize',50)
title('measure vs segment','fontsize',60)
print -r300 -djpeg90 buttonsegmentplot.jpg
print -r300 -dbmp buttonsegmentplot.bmp
