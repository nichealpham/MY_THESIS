...
%------ SPECIFY DATA ------------------------------------------------------
PATH= 'E:\MY_THESIS\database\arrhythmia'; % path, where data are saved
HEADERFILE= '103.hea';      % header-file in text format
ATRFILE= '103.atr';         % attributes-file in binary format
DATAFILE='103.dat';         % data-file
